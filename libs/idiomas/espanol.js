...
const smsAvisos6 = () => { return ` 『 *_༺ღ༒🚫𝐀𝐓𝐄𝐍𝐂𝐈𝐎́𝐍 🚫༒ღ༻_* 』\n\n*ᥲһ᥆rᥲ s᥆ᥣ᥆ ᥣ᥆s ᥲძmіᥒs ⍴ᥙᥱძᥱᥒ ᥱძі𝗍ᥲr ᥣᥲ іᥒ𝖿᥆rmᥲᥴі᥆́ᥒ ძᥱᥣ grᥙ⍴᥆.*` } 
const smsAvisos7 = () => { return ` 『 *_༺ღ༒🚫𝐀𝐓𝐄𝐍𝐂𝐈𝐎́𝐍 🚫༒ღ༻_* 』\n\n*ᥲһ᥆rᥲ 𝗍᥆ძ᥆s ᥣ᥆s ⍴ᥲr𝗍іᥴі⍴ᥲᥒ𝗍ᥱs ⍴ᥙᥱძᥱᥒ ᥱძі𝗍ᥲr ᥣᥲ іᥒ𝖿᥆rmᥲᥴі᥆́ᥒ ძᥱᥣ grᥙ⍴᥆.*` }
const smsAvisos8 = () => { return ` 『 *_༺ღ༒🚫𝐀𝐓𝐄𝐍𝐂𝐈𝐎́𝐍 🚫༒ღ༻_* 』\n\n*ᥣᥲ ძᥱsᥴrі⍴ᥴі᥆́ᥒ ძᥱᥣ grᥙ⍴᥆ 𝖿ᥙᥱ ᥴᥲmᑲіᥲძᥲ ᥴ᥆ᥒ ᥱ́᥊і𝗍᥆.*` }
const smsAvisos9 = () => { return ` 『 *_༺ღ༒🚫𝐀𝐓𝐄𝐍𝐂𝐈𝐎́𝐍 🚫༒ღ༻_* 』\n\n*ᥱᥣ ᥒ᥆mᑲrᥱ ძᥱᥣ grᥙ⍴᥆ 𝖿ᥙᥱ ᥴᥲmᑲіᥲᥒძ᥆ ᥴ᥆ᥒ ᥱ́᥊і𝗍᥆.*` }
