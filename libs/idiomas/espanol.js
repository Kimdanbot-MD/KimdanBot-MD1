...
//call
const smscall = () => { return `*_༺ღ༒  🚫 𝐀𝐓𝐄𝐍𝐂𝐈𝐎́𝐍  🚫 ༒ღ༻_*` }
const smscall2 = () => { return `һᥲs ɾᥱᥲᥣіzᥲძ᥆ ᥙᥒᥲ ᥣᥣᥲოᥲძᥲ ᥲ "𝐊𝐢𝐦𝐝𝐚𝐧𝐁𝐨𝐭-𝐌𝐃". ⍴᥆ɾ ᥣ᥆ 𝗍ᥲᥒ𝗍᥆ sᥱɾᥲ́s ᑲᥣ᥆𝗊ᥙᥱᥲძ᥆, sі ᥣᥣᥲოᥲs𝗍ᥱ ⍴᥆ɾ ᥱɾɾ᥆ɾ ᥴ᥆ოᥙᥒі́ᥴᥲ𝗍ᥱ ᥴ᥆ᥒ ოі ᥴɾᥱᥲძ᥆ɾ.` }
...
const smsAvisos2 = () => { return `『 *_༺ღ༒🚫𝐀𝐓𝐄𝐍𝐂𝐈𝐎́𝐍 🚫༒ღ༻_* 』\n\n*grᥙ⍴᥆ ᥴᥱrrᥲძ᥆, ᥲһ᥆rᥲ s᥆́ᥣ᥆ ᥲძmіᥒs ⍴ᥙᥱძᥱᥒ mᥲᥒძᥲr mᥱᥒsᥲȷᥱs.*` }
const smsAvisos3 = () => { return ` 『 *_༺ღ༒🚫𝐀𝐓𝐄𝐍𝐂𝐈𝐎́𝐍 🚫༒ღ༻_* 』\n\n*grᥙ⍴᥆ ᥲᑲіᥱr𝗍᥆, ᥲһ᥆rᥲ 𝗍᥆ძ᥆s ᥣ᥆s mіᥱmᑲr᥆s ძᥱᥣ grᥙ⍴᥆ ⍴ᥙᥱძᥱᥒ mᥲᥒძᥲr mᥱᥒsᥲȷᥱs.* ` }
const smsAvisos4 = () => { return `◌⑅⃝●♡⋆♡ ցɾմթօ αճíҽɾԵօ ♡⋆♡●⃝⑅◌` } 
const smsAvisos5 = () => { return `◌⑅⃝●♡⋆♡ cαოճíօ lօs αյմsԵҽs ♡⋆♡●⃝⑅◌` }
const smsAvisos6 = () => { return `*ᥲһ᥆rᥲ 𝗍᥆ძ᥆s ᥣ᥆s ᥲძmіᥒs ⍴ᥙᥱძᥱᥒ ᥱძі𝗍ᥲr ᥣ᥆s ᥲȷᥙs𝗍ᥱs ძᥱᥣ grᥙ⍴᥆.*` } 
const smsAvisos7 = () => { return `*ᥲһ᥆rᥲ 𝗍᥆ძ᥆s ᥣ᥆s ⍴ᥲr𝗍іᥴі⍴ᥲᥒ𝗍ᥱs ⍴ᥙᥱძᥱᥒ ᥱძі𝗍ᥲr ᥣ᥆s ᥲȷᥙs𝗍ᥱs ძᥱᥣ grᥙ⍴᥆.*` }
const smsAvisos8 = () => { return `*ᥣᥲ ძᥱsᥴrі⍴ᥴі᥆́ᥒ ძᥱᥣ grᥙ⍴᥆ 𝖿ᥙᥱ ᥴᥲmᑲіᥲძᥲ ᥴ᥆ᥒ ᥱ́᥊і𝗍᥆.*` }
const smsAvisos9 = () => { return `*ᥱᥣ ᥒ᥆mᑲrᥱ ძᥱᥣ grᥙ⍴᥆ 𝖿ᥙᥱ ᥴᥲmᑲіᥲᥒძ᥆ ᥴ᥆ᥒ ᥱ́᥊і𝗍᥆.*` }
