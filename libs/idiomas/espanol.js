...
ingrese:`🍧(づ￣ ³￣)づ🍧 ❥ *Porfavor ingrese su número de serie. ¿No lo recuerdas? No te preocupes, verifica tu número de serie con el comando #myns*`, 
...
largo:`*𝐐𝐮𝐞́ 𝐧𝐨𝐦𝐛𝐫𝐞 𝐭𝐚𝐧 𝐥𝐚𝐫𝐠𝐨, ¿𝐐𝐮𝐞 𝐪𝐮𝐢𝐞𝐫𝐞𝐬 𝐪𝐮𝐞 𝐡𝐚𝐠𝐚 𝐮𝐧 𝐯𝐞𝐬𝐭𝐢𝐝𝐨 𝐜𝐨𝐧 𝐞𝐥?* 🧶👗 \n(￣へ ￣ 凸⁉️`, 
 a:`*🌺◌⑅⃝●♡⋆♡ 𝐕 𝐄 𝐑 𝐈 𝐅 𝐈 𝐂 𝐀 𝐑 ♡⋆♡●⑅⃝◌🌺*\n\nrᥱᥴᥙᥱrძᥲ іᥒgrᥱsᥲr 𝗍ᥙ ᥒ᥆mᑲrᥱ/ 𝐚𝐩𝐨𝐝𝐨 ᥡ 𝗍ᥙ ᥱძᥲძ ⍴ᥲrᥲ ⍴᥆ძᥱr rᥱgіs𝗍rᥲr𝗍ᥱ.\n\n*_🫐𝐄 𝐉 𝐄 𝐌 𝐏 𝐋 𝐎🫐_*`, 
