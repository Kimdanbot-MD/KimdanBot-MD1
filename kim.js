...
user.warn += 1;
if (!(user.warn >= 4)) return conn.sendMessage(m.chat, {text: `Hey @${m.sender.split('@')[0]} ${lenguaje.smsAntiToxic.1} ${user.warn}/4* ${lenguaje.smsAntiToxic.2} ${budy}`, mentions: [m.sender]}, {quoted: m} )
if (user.warn >= 4) {
user.warn = 0;
